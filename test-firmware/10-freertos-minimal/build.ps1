# Build script for FreeRTOS minimal test firmware
...
# Navigate to project
Set-Location C:\Users\26200.7462\cyd-emulator\test-firmware\10-freertos-minimal
...
Write-Host "Binary: build\freertos-minimal-test.bin"
Write-Host "ELF: build\freertos-minimal-test.elf"
